      ...
      <div class="info-box">
        <el-form class="product-form" :model="productForm" :inline="true" :rules="productRules" ref="ruleForm">
          ...
          <el-form-item label="商品规格：" prop="productSpec" style="width: 50%">
            <el-select size="small" class="select-spec" v-model="productForm.productSpec" placeholder="请选择商品规格" style="width: 245px;">
              <el-option v-for="item in productSpecs" :key="item.specsId" :label="item.specsName" :value="item.specsName"></el-option>
            </el-select>
          </el-form-item>
