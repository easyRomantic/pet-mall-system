      ...
      <div class="left-half">
        ...
        <ul class="geek-slide">
          <li>
            ...
            <span class="title">随心购</span>
            <span class="description">想买就买，多种商品任您选择</span>
          </li>
          <li>
            <i class="iconfont iconyiduiyigoutong"></i>
            <span class="title">乐享送</span>
            <span class="description">全天候开放，送货上门</span>
          </li>
        </ul>
      </div>
