 ...
 */
@Component
public class MallPlatServerRunner implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(MallPlatServerRunner.class);
    ...
    public void run(ApplicationArguments args) {
        ...
        Long increment = redisTemplate.opsForValue().increment("shiro:cache" + ":user.id");
